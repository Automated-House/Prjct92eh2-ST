/**
 *  Iris Keyfob with Presence
 *
 *  Copyright 2015 Mitch Pond
 *  Modified by prjct92eh2 2018 with code from Zigbee button and Arrival Sensor HA
 *
...
metadata {
    definition (name: "Iris KeyFob With Presence", namespace: "prjct92eh2", author: "prjct92eh2", mnmn: "SmartThings", vid: "generic-arrival") {
        capability "Actuator"
        capability "Battery"
        capability "Button"
    ...
    tiles(scale: 2) {
        ...
        main (["presence"])
        details(["presence", "button", "battery", "refresh"])
    }
}
