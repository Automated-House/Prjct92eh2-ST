...
metadata {
	definition(name: "Iris IL061 Contact Sensor", namespace: "prjct92eh2", author: "prjct92eh2", mnmn: "SmartThings", vid: "generic-contact") {
        ...
        fingerprint inClusters: "0000,0001,0003,0020,0402,0500,0B05", outClusters: "0019", manufacturer: "iMagic by GreatStar", model: "1116-S", deviceJoinName: "Iris V3 Contact Sensor"
	}
